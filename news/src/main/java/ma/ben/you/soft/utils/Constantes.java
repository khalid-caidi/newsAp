...
public interface Constantes {
	...
	interface GlobalConstant_Page{
		static final String GEST_ACCUEIL_PAGE = "/accueil.xhtml";
	}
	...
	interface GlobalConstant{
		...
		static final Integer IND_VALID_1 = 1;
		...
		static final String LIST_PROJET = "listPorts";
		...
		static final String CODE_TERMINAL = "codeTerminal";
		static final String GESTION_DECOMPTE = "Gestion administration ressource";
